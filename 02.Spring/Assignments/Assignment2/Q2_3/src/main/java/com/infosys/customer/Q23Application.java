...
public class Q23Application implements CommandLineRunner {
	@Autowired
	CustomerService customerService;

	public static void main(String[] args) {
		SpringApplication.run(Q23Application.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		switch (operation) {
			...
			case 3:
				System.out.println("Enterr customer ID to fetch information");
				customerId = scanner.nextInt();
			...
			case 4:
				...
				interactions.forEach(interaction1 -> System.out.println(interaction1.toString()));
				break;
			...
			case 8:
				...
				interactions.forEach(interaction1 -> System.out.println("Feedback for product is: "+interaction1.getInteractionFeedback()));
				break;
